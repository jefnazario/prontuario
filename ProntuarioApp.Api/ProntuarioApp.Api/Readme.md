...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *DashBoard*):
...
Execute unit tests
```
    cd "DashBoard/test/DashBoard.Tests"
    dotnet test
```
