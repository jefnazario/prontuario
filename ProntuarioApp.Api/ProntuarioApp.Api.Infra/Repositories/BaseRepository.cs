...
namespace ProntuarioAppAPI.Infra.Repositories
{
    public abstract class BaseRepository
    {
        private readonly string connectionString = "server=35.202.183.206;User Id=prontuario;database=prontuario_unificado; password=prontuario@grupomeri";
